...
public class AmazonConstants {
    ...
    public static final String TODAYS_DEAL_FILTER_SUMMARY = "FilterItemView_all_summary";
    ...
    public static final String PRICE_ID = "priceblock_ourprice";
    public static final String PRICE_ID_V2 = "priceblock_dealprice";

    public static final String REVIEW_CSS_CLASS = ".a-size-small.a-color-base";
    public static final String PRODUCT_IMAGE_ID = "imgTagWrapperId";
